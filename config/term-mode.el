...
(add-hook 'term-mode-hook (lambda()
    ...
    (define-key term-raw-map (kbd "C-<left>") (lambda() (interactive)
      (term-send-raw-string "\eb")))

    (define-key term-raw-map (kbd "C-<right>") (lambda() (interactive)
        (term-send-raw-string "\ef")))
    (define-key term-raw-map (kbd "C-<delete>") (lambda() (interactive)
        (term-send-raw-string "\ed")))
    (define-key term-raw-map (kbd "C-<backspace>") (lambda() (interactive)
    ...
    (define-key term-raw-map (kbd "C-v") (lambda() (interactive)
        (term-send-raw-string (gui-get-primary-selection))))



    (define-key term-mode-map (kbd "C-c") 'clipboard-copy)
    (define-key term-mode-map [escape] (lambda() (interactive)
